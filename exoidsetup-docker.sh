...
docker pull codeproject/ai-server:rpi64-2.9.7 > /dev/null
check_command "Failed to pull CodeProject.AI Docker image."

progress 90 "Running CodeProject.AI container..."
docker run --name CodeProject.AI -d --restart unless-stopped -p 32168:32168 codeproject/ai-server:rpi64-2.9.7 > /dev/null
